...
### TARGETING TRANSLATION {.custom-position}

::: {.grid}
::: {.g-col-12 .g-col-md-6 .text-center}
![](images/resources/Schematic_square.png){style="width:300px; display:block; margin:5px auto -20px auto;"}
:::
::: {.g-col-12 .g-col-md-6}
**2026** | Using the eIF4A inhibitor zotatifin with the BCL2 inhibitor venetoclax to target AML cells.

* <i class="fa-regular fa-file-lines"></i> [Paper](https://doi.org/10.1016/j.bneo.2026.100202): Lee YS *et al.* Synergistic targeting of eIF4A-mediated translation initiation and apoptosis in acute myeloid leukemia. Blood Neoplasia, 2026
* <i class="fab fa-github"></i> [reanalyze-aml2019](https://github.com/petervangalen/reanalyze-aml2019/): Expression of translation initiation factors including *EIF4A1* in healthy bone marrow and AML cell subpopulations (folder: 2026_Lee).
* <i class="fab fa-github"></i> [AML-DepMap-Insights-2024](https://github.com/petervangalen/AML-DepMap-Insights-2024): From DepMap and PRISM, evaluate *EIF4A* expression and zotatifin sensitivity in AML cell lines (folder: 2026_Lee).
* <i class="fab fa-github"></i> [DrugSynergy_2026](https://github.com/petervangalen/DrugSynergy_2026): RNA- and ribosome-sequencing analysis as described in the paper.
* <i class="fa-solid fa-dna"></i> [GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE317371): RNA- and ribosome-sequencing data.
:::
:::

---

### HUMAN HSC AGING {.custom-position}

::: {.grid}
::: {.g-col-12 .g-col-md-6 .text-center}
![](images/resources/iHSCs.png){style="width:300px; display:block; margin:5px auto -20px auto;"}
:::
::: {.g-col-12 .g-col-md-6}
**2026** | Using consensus non-negative matrix factorization to discover programs driving HSC aging.

* <i class="fa-regular fa-file-lines"></i> [Paper](https://doi.org/10.1186/s13059-026-03936-z): Safina KR *et al.* An inflammatory and quiescent HSC
subpopulation expands with age in humans. Genome Biology, 2026
* <i class="fab fa-github"></i> [Aging_HSCs_2025](https://github.com/noranekonobokkusu/Aging_HSCs_2025): Scripts to reproduce analyses including differential gene expression, cNMF, and GSEA.
* <i class="fa-solid fa-dna"></i> [GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE302126): Single-cell RNA-seq data (additional datasets are described in paper's data availability section).
:::
:::
...
* <i class="fa-solid fa-dna"></i> [Figshare](https://figshare.com/projects/Single-cell_BPDCN/272326): Seurat objects with single-cell sequencing data.
:::
:::
...
* <i class="fa-solid fa-dna"></i> [Figshare](https://doi.org/10.6084/m9.figshare.30581066): Seurat object with single-cell sequencing data.
:::
:::
...
::: {.g-col-12 .g-col-md-6}
<div class="addgene-container">
<!-- From Addgene website -->
<div style="width: 280px; border: thin solid #888; padding: 10px; text-align: center;"><a href="https://www.addgene.org/Peter_van_Galen/" style="text-decoration: none; color: #585858; font-size: 16px; font-family: Arial,Helvetica,sans-serif;" target="_blank" rel="noopener noreferrer"><b>Peter van Galen Lab</b><br>Find and request materials through<br><img style="margin-top: 16px;" width="250" height="48" alt="Addgene" src="https://media.addgene.org/cms/filer_public/ea/82/ea826144-fce2-4c13-99e9-940af7e2853b/logo-addgene.png"></a></div>
</div>
:::
...
data <- tribble(
  ...
  "ATF4 reporter"                                                                                                                                                                                      ,
  "van Galen P, Kreso A, Mbong N, *et al.* The unfolded protein response governs integrity of the haematopoietic stem-cell pool during stress. [Nature,](https://doi.org/10.1038/nature13228) 2014."   ,
  "pSMALB-ATF4.12"                                                                                                                                                                                     ,
  "ATF4 5' UTR, ATF4-eGFP fusion ORF, TagBFP"                                                                                                                                                          ,
  ...
  "van Galen P, Kreso A, Mbong N, *et al.* The unfolded protein response governs integrity of the haematopoietic stem-cell pool during stress. [Nature,](https://doi.org/10.1038/nature13228) 2014."   ,
  "pMAL"                                                                                                                                                                                               ,
  "Gateway cloning element"                                                                                                                                                                            ,
  "Bidirectional expression vector (pPGK promoter, GFP)"                                                                                                                                               ,
  "van Galen P, Kreso A, Wienholds E, *et al.* Reduced lymphoid lineage priming promotes human hematopoietic stem cell expansion. [Cell Stem Cell,](https://doi.org/10.1016/j.stem.2013.11.021) 2014." ,
  "pMALB"                                                                                                                                                                                              ,
  "Gateway cloning element"                                                                                                                                                                            ,
...
* [Harvard Cancer Consortium's Continuing Umbrella of Research Experiences (CURE) Program](https://www.dfhcc.harvard.edu/research/cancer-disparities/students/cure-overview) for student internships
...
* [Massachusetts Institute of Technology (MIT) Research Science Institute (RSI)](https://www.cee.org/programs/research-science-institute) for high school students
...
![](images/resources/pivot_longer.jpg){.mobile-center style="width:300px; float:right;"}
...
* Harvard Chan Bioinformatics Core ([Workshops](https://hsph.harvard.edu/research/bioinformatics/training/))
