...
::: {.column-body layout="[1,1]" style="float:center;"}

![](images/resources/BPDCN-UV.png){style="width:300px; display:block; margin:auto;"}

::: {.g-col-1}
**2023** | Dendritic cell leukemia evolution.
...
![](images/resources/MAESTER.png){style="width:300px; display:block; margin:auto;"}

::: {.g-col-1}
**2022** | Resolving clonal populations using mitochondrial variants.
...
![](images/resources/WAT3R-logo.png){style="width:150px; display:block; margin:auto;"}

::: {.g-col-1}
**2022** | T cell receptor (TCR) recovery from 3' single-cell RNA-sequencing
...
![](images/resources/BPDCN-T-cells.png){style="width:300px; display:block; margin:auto;"}

::: {.g-col-1}
**2022** | Description of project
...
![](images/resources/Single-cell_AML.jpg){style="width:300px; display:block; margin:auto;"}
...
![](images/resources/MintChIP.png){style="width:300px; display:block; margin:auto;"}

::: {.g-col-1}
**2016** | Low input ChIP-seq
...
![](images/resources/pivot_longer.jpg){style="width:300px; float:right; margin:0 0 20px 20px;"}
